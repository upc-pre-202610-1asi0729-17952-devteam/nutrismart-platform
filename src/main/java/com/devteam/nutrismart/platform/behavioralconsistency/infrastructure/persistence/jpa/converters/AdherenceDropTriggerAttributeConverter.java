...
/**
 * Convertidor JPA para el enum {@code AdherenceDropTrigger}.
...
public class AdherenceDropTriggerAttributeConverter implements AttributeConverter<AdherenceDropTrigger, String> {

    @Override
    public String convertToDatabaseColumn(AdherenceDropTrigger attribute) {
        return attribute == null ? null : attribute.name();
    }

    @Override
    public AdherenceDropTrigger convertToEntityAttribute(String dbData) {
        return dbData == null ? null : AdherenceDropTrigger.valueOf(dbData);
    }
}
